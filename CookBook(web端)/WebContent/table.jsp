...
<body class="flat-blue sidebar-collapse">
	...
	<div class="content-container wrap">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<span class="page-title red"><h3>菜谱信息查询</h3></span>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="content-block">
						<div class="block-title">菜谱信息</div>
						<div class="block-content">
							<table id="example" class="table table-striped" cellspacing="0"
								...
								<tbody>
									<c:forEach items="${picList }" var="pli">
										<tr>
											<td>${pli.pId }</td>
											<td>${pli.pDish}</td>
											<td>${pli.pCaption }</td>
											<td>${pli.pType}</td>
											<td><img src="${pli.pImg}" /></td>
											<td><a href="" onclick="state('${pli.pId }');">删除</a></td>
										</tr>
	...
	<script type="text/javascript">
		function state(pid) {
			var flag = confirm("确认删除该条数据吗?");
			if (flag == true) {
				window.location.href = "${pageContext.request.contextPath }/delpicturebyid.do?pId="
						+ pid;
			}
